...
#
# Usage: deploy_github_pages.sh <version> <ts_docs_dir> <extra_docs_dir> <github_docs_subdir> <github_repo> <github_token> <project_subdir>
#
# Arguments:
...
EXTRA_DOCS_DIR="${3:?Missing extra docs directory}"
GITHUB_DOCS_SUBDIR="${4:?Missing GitHub docs subdirectory}"
...
# Create project directory structure: project/{version}/{subdir}/ with ts subdir
...
# Generate index.html for docs subdir (lists ts only for workerbee)
...
Source: https://gitlab.syncad.com/hive/workerbee"
