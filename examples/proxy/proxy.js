...
var wsIncoming = {
  ...
  stream : function stream(req, socket, options, head, server, clb) {
    ...
    var proxyReq = (common.isSSL.test(options.target.protocol) ? https : http$1).request(
...
var http = require$$0$3, httpProxy = httpProxy$1;
