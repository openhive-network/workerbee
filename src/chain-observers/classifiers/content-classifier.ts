...
export type TContentAuthorData = Record<string, IHiveContent>;

export interface IContentData {
  contentData: Record<TAccountName, TContentAuthorData>;
}

export class ContentClassifier extends CollectorClassifierBase<IContentData> {}
