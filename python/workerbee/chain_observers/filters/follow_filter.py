"""FollowFilter — matches custom_json with id="follow" where json[0]=="follow".

Mirrors src/chain-observers/filters/follow-filter.ts.
        ...
        for entry in custom_json_ops:
            ...
            if operation["id"] == "follow":
                ...
                try:
                    ...
                    if parsed[0] == "follow" and parsed[1]["follower"] in self._accounts:
                        return True
