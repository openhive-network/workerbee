...
- Automatic continuation of the same historical subscription into live observation is not part of the current Python contract. Use the manual pattern above unless the TS behavior is clarified and the Python implementation is updated to match it.
