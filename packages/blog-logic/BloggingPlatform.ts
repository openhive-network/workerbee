...
export class BloggingPlatform implements IBloggingPlatform {
   ...
   * @param accountName account name or community.
   */
  public configureViewContext(accountName: IAccountIdentity): void {
    this.viewerContext = accountName;
  }
  ...
  public overwriteGetTitleImage(callbackMethod: () => string) {
    this.overwrittenGetTitleImage = callbackMethod;
  }
}
